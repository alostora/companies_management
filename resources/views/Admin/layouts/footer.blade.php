...
<!--ajax-->
<script src="{{url('dashboard/ajax.js')}}"></script>
...
<script>
		...
		var anotherEmployerInterviewForm = document.getElementById('anotherEmployerInterviewForm');
		...
		function anotherEmployerInterviewFormm(){
		 	anotherEmployerInterviewForm.style.display = "block";
		};
