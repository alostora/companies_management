...
<div class="infopage"><i class="fa fa-file-text-o"></i> الخدمات والاجراءت </div>
  ...
  <td class="tdright"> 
	...
	<button id="clicktwo" class="texttd texttd leftclick-one" ><i class="fa fa-file-text-o"></i> الخدمات والاجراءت <i class="fa fa-angle-left drop"></i></button>
	...
	<li class="leftclick-one" >طلبات الموارد البشرية</li>
		<div id="leftdropdown-one" style="display:none;width: max-content;">	
			<ul class="ultext">
			<li><a href="addvacation.html"><i class="fa fa-file-text-o"></i> طلب اجازة</a></li>
...
تاريخ البداية <input type="date" class="dateinput" name="startdate" placeholder="تاريخ البداية"> <i class="fa fa-calendar" aria-hidden="true"></i>
</div></div>


<div class="textsendpage">	
<div class="holderinput date">
تاريخ النهاية <input type="date" class="dateinput" name="enddate" placeholder="تاريخ النهاية"> <i class="fa fa-calendar" aria-hidden="true"></i>
</div></div>
...
<button type="submit" class="busub">حفظ</button>
