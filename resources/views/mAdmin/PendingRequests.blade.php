...
<style>.texttd.pendingre {background: #4192d7;border-radius: 8px;}</style>
</head>
<body>
<header>
...
<menu>
<style>.texttd.colorpending {background: #4192d7;border-radius: 8px;}</style>
<div id="holdersite">
<div class="infopage"><img src="{{url('design/admin/site/img/touch2.png')}}" class="serviceicone"> الطلبات المعلقة </div>
...
<table class="ultext">
<tbody>
<tr><td>الطلب رقم 1</td><td>&nbsp;</td></tr>
<tr><td>الطلب رقم 2</td><td>&nbsp;</td></tr>
<tr><td>الطلب رقم 3</td><td>&nbsp;</td></tr>
</tbody>
</table>
