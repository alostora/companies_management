...
.lidot.notifications{background:#4192d7;color:#fff;}
...
<div id="divsortphone-one" class="dropdownone" style="display:block">
	...
	<button  class="texttd leftclick-one" style="background:#4192d7;"><i class="fa fa-bookmark"></i> التعاميم <i class="fa fa-chevron-circle-down"></i></button>
	<div id="leftdropdown-one" style="display:none">
	...
	<button  class="texttd leftclick-one" style="background:#4192d7;"><i class="fa fa-commenting"></i> القرارات<i class="fa fa-chevron-circle-down"></i></button>
	<div id="leftdropdown-one" style="display:none">
	...
	<div class="holderdropdown grey">
	<button  class="texttd leftclick-one" style="background:#4192d7;"><i class="fa fa-address-card"></i> نتائج الاجراءات التى قام بها الموظف من اخر اجراء تم على اجازته مثلا التى قدمها او غيرها<i class="fa fa-chevron-circle-down"></i></button>
	<div id="leftdropdown-one" style="display:none">
