...
<style>
.texttd.colorsettingsnotion {background: #4192d7;border-radius: 8px;}
.lidot.dashboard{background:#4192d7;color:#fff;}
.addvaction.side{background:#4192d7;color:#fff;}
.settings.dropdownbbmkb{display:block}
</style>
</head>
<body>
<header>
...
<menu>
<div id="holdersite">
<div class="infopage"><i class="fa fa-gear"></i> اعدادات</div>

<div class="holderrightpc right">

    <button id="clicktwo" class="texttd" onClick="parent.location='{{url("myusers")}}'" ><i class="fa fa-users" aria-hidden="true"></i> موظفينى <i class="fa fa-angle-left"></i></button>
		
    <button id="clickone" class="texttd texttd" onClick="parent.location='{{url("profile")}}'"> <img src="{{url('design/admin/site/img/data.png')}}" class="iconesv"> الملف الشخصى <i class="fa fa-angle-left"></i></button>    
	...
	<li class="leftclick-one" >طلبات الموارد البشرية</li>
		<div id="leftdropdown-one" style="width: max-content;">	
			<ul class="ultext">
			<li><a href="addvacation.html" class="addvactionside"><i class="fa fa-file-text-o"></i> طلب اجازة</a></li>
	...
	<button id="clicktwo" onClick="parent.location='{{url("PendingRequests")}}'" class="texttd"><img src="{{url('design/admin/site/img/touch.png')}}" class="serviceicone">الطلبات المعلقة <i class="fa fa-angle-left"></i></button>
	  
	<button id="clicktwo" onClick="parent.location='{{url("Vieworders")}}'" class="texttd"><i class="fa fa-file" aria-hidden="true"></i> عرض الطلبات <i class="fa fa-angle-left"></i></button>
	   
	<button id="clicktwo"  class="texttd texttd leftclick-one"><i class="fa fa-gear"></i>  اعدادات <i class="fa fa-angle-left drop"></i></button>
	<div id="leftdropdown-one" style="display:none">	
	<ul class="ultext">
	<li onClick="parent.location='{{url("settingsdashboard")}}'">لوحة بيانتى </li>
	<li onClick="parent.location='{{url("settingsnotifications")}}'"> قائمة التبليغات</li>
	</ul>
	</div>		
...
<div id="divsortphone-one" class="dropdownone" style="display:block">
	...
	<div class="holderdropdown grey">
	<button  class="texttd leftclick-one" style="background:#4192d7;"><i class="fa fa-credit-card"></i> ارصدة الاستحقاق <i class="fa fa-chevron-circle-down"></i></button>
	<div id="leftdropdown-one" style="display:none">
	...
	<div class="holderdropdown blue">
	<button  class="texttd leftclick-one" style="background:#4192d7;"><i class="fa fa-file-text-o"></i> قسيمة الراتب <i class="fa fa-chevron-circle-down"></i></button>
	<div id="leftdropdown-one" style="display:none">
    ...
    <div class="holderdropdown grey">
	<button  class="texttd leftclick-one" style="background:#4192d7;"><i class="fa fa-calendar"></i> سجل الانجازات والغيابات <i class="fa fa-chevron-circle-down"></i></button>
	<div id="leftdropdown-one" style="display:none">
    ...
    <div class="holderdropdown blue">
	<button  class="texttd leftclick-one" style="background:#4192d7;"><i class="fa fa-graduation-cap"></i> سجل الدوارات التدريبية <i class="fa fa-chevron-circle-down"></i></button>
	<div id="leftdropdown-one" style="display:none">
    ...
    <div class="holderdropdown grey">
	<button  class="texttd leftclick-one" style="background:#4192d7;"><i class="fa fa-money"></i> سجل الراتب الاساسى <i class="fa fa-chevron-circle-down"></i></button>
	<div id="leftdropdown-one" style="display:none">
...
<script>$(".settingsnotidas").css("display","block");</script>
